...
BOT_TOKEN = "5319057604:AAFwmESzdM-37CQrMaBVg6DrcvDXSxHY1OM"
PAYMENT_CHANNEL = "@-1780305353" #add payment channel here including the '@' sign
OWNER_ID = 1677088318 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@-1780305353"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
